...
class ClientService {
  static final _client = HttpClientWithInterceptor.build(interceptors: [
    GeodestInterceptor(),
  ]);
  ...
  static Future<http.Response> login(Map<String, dynamic> body) async {
    return await _client.post(Uri.parse(CommonService.loginUrl),
  ...
  static Future<http.Response> postDelivery(Map<String, dynamic> body) async {
    return await _client.post(Uri.parse("${CommonService.deliveryUrl}/"),
        body: jsonEncode(body),
        headers: <String, String>{'Content-Type': 'application/json'});
  }

  static Future<http.Response> getDeliveries() async {
    return await _client.get(Uri.parse(CommonService.deliveryUrl),
        headers: <String, String>{'Content-Type': 'application/json'});
  }

  static Future<http.Response> completeDelivery(
      {int id, Map<String, dynamic> body}) async {
    //Hardcoding the finale state
  ...
  static Future<http.Response> changeDeliveryState(
      {int deliveryId, Map<String, dynamic> body}) async {
    return await _client.put(
  ...
  static void sendEtaToWebsocket({String username, Map<String, dynamic> body}) {
    IOWebSocketChannel channel = IOWebSocketChannel.connect(
        Uri.parse("${CommonService.wsBaseUrl}/$username/"));
  ...
  static Future<http.Response> refreshToken() async {
    ...
    return await _client.post(Uri.parse(CommonService.refreshTokenUrl),
        headers: <String, String>{'Content-Type': 'application/json'},
  ...
  static Future<http.Response> getUsername() async {
    return await _client.get(Uri.parse(CommonService.usernameUrl),
        headers: <String, String>{'Content-Type': 'application/json'});
  }

  /// credits
  static Future<http.Response> getCreditInfo() async {
    return await _client.get(Uri.parse(CommonService.creditsUrl),
        headers: <String, String>{'Content-Type': 'application/json'});
  }
  ...
  static Future<http.Response> sendRequest(
    ...
    switch (method) {
      ...
      case "PUT":
        {
          return await _client.put(Uri.parse(url), headers: headers);
        }
      default:
        {
